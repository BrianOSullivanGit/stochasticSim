...
(${SAMTOOLS} sort ${hap2PreTumourBamPrefix}.spike.sam || { echo -e "\n\033[7mSAMTOOLS SORT hap 2 failed! \033[0m" 1>&2;exit 1; }) > ${hap2PreTumourBamPrefix}.spike.bam
